...
def _resultado_demo():
    return {
        ...
        "pronosticos": [
            {
                "local": "América", "visitante": "Cruz Azul", "pick_1x2": "Gana Local",
                "prob_local_pct": 55.2, "prob_empate_pct": 24.1, "prob_visitante_pct": 20.7,
                "prob_pick_pct": 55.2, "nivel_confianza": "ALTA",
                "pick_ou": "Over", "prob_over_pct": 58.0, "pick_btts": "Sí",
                "marcador_mas_probable": "2-1",
                "explicacion_1x2": "América domina de local con mejor ataque esta temporada.",
                "mercado": {
                    "1x2": {"momios": {"local": "1.80", "empate": "3.40", "visita": "4.20"},
                            "favorito_mercado": "América", "hay_valor": True, "valor_en": "América"},
                    "over_under": {"momios": {"over": "1.90", "under": "1.90"}, "linea": 2.5,
                                   "mercado_ve": "explosivo"},
                },
            },
            {
                "local": "Tigres", "visitante": "Rayados", "pick_1x2": "Empate",
                "prob_local_pct": 38.0, "prob_empate_pct": 33.0, "prob_visitante_pct": 29.0,
                "prob_pick_pct": 33.0, "nivel_confianza": "MEDIA",
                "pick_ou": "Under", "prob_over_pct": 40.0, "pick_btts": "No",
                "marcador_mas_probable": "1-1",
            },
            {
                "local": "Toluca", "visitante": "Puebla", "pick_1x2": "Gana Local",
                "prob_local_pct": 62.0, "prob_empate_pct": 21.0, "prob_visitante_pct": 17.0,
                "prob_pick_pct": 62.0, "nivel_confianza": "ALTA",
                "pick_ou": "Over", "prob_over_pct": 64.0, "pick_btts": "Sí",
...
def main() -> int:
    tops = [
        {"equipo": "América", "rival": "Cruz Azul", "condicion": "Local",
         "no_perder_pct": 79.3, "prob_victoria_pct": 55.2, "nivel": "ALTA",
         "razon": "local fuerte vs un rival en mala racha de visitante"},
        {"equipo": "Toluca", "rival": "Puebla", "condicion": "Local",
         "no_perder_pct": 83.0, "prob_victoria_pct": 62.0, "nivel": "ALTA"},
        {"equipo": "Tigres", "rival": "Rayados", "condicion": "Local",
         "no_perder_pct": 71.0, "prob_victoria_pct": 38.0, "nivel": "MEDIA"},
    ]
    contexto = {
        "home": "América", "away": "Cruz Azul",
        "prediccion_api": {"prob_local_pct": 54.0, "prob_empate_pct": 25.0,
                           "prob_visita_pct": 21.0, "goles_esp": "1.9-1.0"},
        "forma_local": "WWDWL", "forma_visita": "LDLWD",
        "en_riesgo_local": [], "en_riesgo_visita": ["J. Rodríguez (amarillas)"],
        "h2h": {"team1": {"name": "América", "wins": 6}, "team2": {"name": "Cruz Azul", "wins": 4},
                "played": 14, "draws": 4, "seasons_covered": 8},
        # Alineación CONFIRMADA (XI) del pick #1.
        "alineacion": {"disponible": True, "equipos": [
            {"equipo": "América", "condicion": "home", "formacion": "4-3-3",
             "titulares": ["Malagón", "Fuentes", "Cáceres", "Reyes", "Espinoza",
                           "Fidalgo", "Sánchez", "dos Santos", "Rodríguez",
                           "Martín", "Aguirre"]},
            {"equipo": "Cruz Azul", "condicion": "away", "formacion": "4-2-3-1",
             "titulares": ["Mier", "Piovi", "Rivero", "Escobar", "Rotondi",
                           "Ditta", "Faravelli", "Lira", "Sepúlveda", "Antuna", "Gutiérrez"]},
        ]},
        # Impacto del XI (fuerza + ausentes clave).
        "impacto_xi": {
            "América": {"fuerza_xi_pct": 96.0, "ausentes_clave": []},
            "Cruz Azul": {"fuerza_xi_pct": 88.5,
    ...
    msg = tp.construir_mensaje(
        _resultado_demo(), tops=tops, contexto_pick=contexto,
    ...
    print("✅ Enviado a Telegram." if ok else
          "❌ No se envió. Revisa TELEGRAM_BOT_TOKEN y TELEGRAM_CHAT_ID.")
