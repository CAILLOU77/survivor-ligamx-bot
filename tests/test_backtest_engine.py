...
class TestRunBacktest(unittest.TestCase):
    def test_usa_validacion_real_no_random(self):
        ...
        validacion = {"accuracy": 0.49, "brier_promedio": 0.63,
                      "baseline_local": 0.45, "mejor_que_baseline": True,
                      "n_evaluados": 100}
        with mock.patch.object(be.fuentes_datos, "obtener_resultados", return_value=datos) as m_datos, \
